...
def workflow():
    ...
    iterations: int = 2000  # Number of points to plot (1000000)
    ...
    fractal_flame: FractalFlame = FractalFlame.create(resolution, rect)

    start_time = time.time()
    fractal_flame.render(iterations, coeffs, num_threads=2)
